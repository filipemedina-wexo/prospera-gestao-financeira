-- Implementar plano de correções para contas a pagar e receber (corrigido)

-- 1. Primeiro, dropar todos os triggers existentes
...
-- 2. Agora dropar e recriar a função validate_account_status
...
-- 4. Melhorar função registrar_recebimento com validações adicionais
...
-- 5. Criar função similar para registrar pagamento
